...
In Windows, if you used the installer, you can start FlexProp from the Start Menu. Otherwise, run it from the folder where you extracted the ZIP file.

On other systems, run flexprop.tcl.
